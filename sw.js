const CACHE_NAME = 'daily-purchase-v4-7-2-20260820';
const APP_SHELL = ['./','./index.html','./styles.css?v=4.7.2','./app.js?v=4.7.2','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png'];
