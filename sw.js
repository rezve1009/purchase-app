const CACHE_NAME = 'daily-purchase-v4-2-20260820';
const APP_SHELL = ['./','./index.html','./styles.css?v=4.2.0','./app.js?v=4.2.0','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png'];
