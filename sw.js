const CACHE_NAME = 'daily-purchase-v4-8-0-20260822';
const APP_SHELL = ['./','./index.html','./styles.css?v=4.8.0','./app.js?v=4.8.0','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png'];
